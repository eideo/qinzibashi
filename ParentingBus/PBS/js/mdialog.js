...
TipBox.prototype.renderUI = function(tipType){   
    ...
    tipType == 'info' && this.infoRenderUI();
    ...
    if(this.config.hasBtn){
        ...
        switch(this.config.type){
            ...
            case 'tip': $(".tip").after("<button class='okoButton'>确定</button>");
                break;
            case 'info': $(".info").after("<button class='okoButton infoBtn'>确定</button>");
                break;
            default: break;
        }
        $('button.okoButton').on('click', function () {
            if (_this.config.type == "info" && _this.config.infoId!=null) {
                var outValueId = "#infoValue_" + _this.config.infoId;
                var outValue = $(outValueId).val();
                var beforeId ="#"+ _this.config.infoId;
                $(beforeId).val(outValue);
            }
...
//填写信息UI  
TipBox.prototype.infoRenderUI = function () {
    var tip = "<div class='info'>";
