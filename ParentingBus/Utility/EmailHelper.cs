...
namespace Utility
{
    public class EmailHelper
    {
        ...
        public static bool SendEmailTo(string body, string emailAddress, string title, string copyto, bool isBodyHtml, Stream stream = null, bool throwOnError = false, string displayName = "一休理财预警", string attachName = "附件.xls")
        {
            ...
            try
            {
                ...
                var from = new MailAddress(Utility.Const.SystemConst.EmailFromAdress, displayName);
                var client = new SmtpClient
                {
                    Host = "smtp.exmail.qq.com",
                    Credentials = new NetworkCredential(Utility.Const.SystemConst.EmailFromAdress, Utility.Util.EncodeAndDecode.DecodeBase64(Encoding.UTF8, Utility.Const.SystemConst.EmailPwd)),
                    Port = 25
                };
                ...
                // 回复至
                mail.ReplyToList.Add(Utility.Const.SystemConst.EmailFromAdress);
